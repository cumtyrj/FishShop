...
public class CartServiceImpl implements CartService{
	...
	@Override
	public void saveCart(int good_id, String price, String name, String detail, String image,String goodtype) {
		// TODO Auto-generated method stub
		Cart cart = new Cart();
		cart.setGood_id(good_id);
		final int i = 1;
		cart.setNum(i);
		cartMapper.saveCart(good_id, price, name, detail, image, goodtype);
	}
