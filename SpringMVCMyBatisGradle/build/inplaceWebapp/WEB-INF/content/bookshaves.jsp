                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <span><i class="icon-leaf"></i><a href="login.jsp">桌椅</a></span>
                                                            </li>
                                                            <li>
                                                                <span><i class="icon-leaf"></i><a href="">书架</a></span> 
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li>
                                                        <ul>
                                                            <li>
                                                                <span><i class="icon-leaf"></i><a href="">器皿</a></span>

                                                            </li>
                                                            <li>
                                                                <span><i class="icon-leaf"></i><a href="">用具</a></span>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
				...
				<div class="col-md-8">
					<div class="row">
						...
						<table border="1">
							...
							<th>操作</th><th>详细</th><th>销量</th><th>库存</th>
							</tr>
							<c:forEach items="${requestScope.bookcase_list }" var="bookcase">
								...
								<td><img src="source/img/${bookcase.image}" height="60"></td>
								<td><a href="save?good_id=${bookcase.good_id}"><button type="button" class="btn btn-default" >加入购物车</button></a>
								<td>${bookcase.detail }</td>
								<td>${bookcase.sales }</td>
								<td>${bookcase.inventory }</td>
								</tr>
							</c:forEach>
							</table>
						</div>
